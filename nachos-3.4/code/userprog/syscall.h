...
void Write(char *buffer, int charcount, OpenFileId id); // Le
 ...
 */
int Read(char *buffer, int charcount, OpenFileId id); // Le
...
/* System calls that provide multi-threading ability: CreateSemaphore, Wait,
 * Signal. To allow the simultaneous execution of multiple programs.
 */
