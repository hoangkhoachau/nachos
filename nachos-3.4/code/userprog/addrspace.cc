...
// 	Create an address space to run a user program.
//	Load the program from the file with the corresponding name,
//	and set everything up so that we can start executing user
//	instructions.
//----------------------------------------------------------------------
...
AddrSpace::AddrSpace(char *filename) {
    ...
    // check if the available memory is enough to load new process
